        ...
        <form className="edit-form" onSubmit={handleSubmit}>
            <div {...getRootProps()} className="dropzone">
                ...
                <div className="img-layout">
                    <img className="project-img" src={formData.image} alt={`${formData.name}'s image`} />
                </div>
            ...
            <div className="dropdown" ref={dropdownRef}>
                <input
                    ...
                    placeholder="Select new project owner"
            ...
            <div className="edit-form-buttons mt-3">
                ...
                <button type="submit" className="btn btn-red btn-small" onClick={handleChangeOwner}>Save</button>
            </div>
        </form>
    );
};