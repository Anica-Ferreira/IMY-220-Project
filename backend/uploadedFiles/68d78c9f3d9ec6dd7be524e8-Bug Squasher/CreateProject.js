        ...
        <div className="edit-form create-form">
            <form>
                ...
                <div {...getImageRootProps()} className="dropzone">
                    ...
                    <p className="text-muted">{isImageDragActive ? "Drop image here..." : "Drag & drop or click to select an image"}</p>
                ...
                <div className="form-group">
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        />
                        <button className="btn-grey ms-2" type="button" onClick={handleAddHashtag}><i className="fas fa-plus"></i></button>
                    </div>
                ...
                <div className="form-group">
                    ...
                    <div {...getFilesRootProps()} className="dropzone">
                        <input {...getFilesInputProps()} />
                        {isFilesDragActive ? <p className="text-muted">Drop files here...</p> : <p>Click or drag files here</p>}
                    </div>
                    {files.length > 0 && (
                        <ul>
                            {files.map((file, idx) => (
                                <li key={idx} onClick={() => handleRemoveFile(idx)}>
